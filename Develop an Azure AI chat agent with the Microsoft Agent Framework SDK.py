...
ls -a -lpython -m venv labenv
./labenv/bin/Activate.ps1
pip install agent-framework==1.0.0b260128 --pre

In .env
mention project endpoint url and model name
AZURE_AI_PROJECT_ENDPOINT="https://project59202592-resource.services.ai.azure.com/api/projects/Project59202592"
